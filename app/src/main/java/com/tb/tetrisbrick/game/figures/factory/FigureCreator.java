...
import static com.tb.tetrisbrick.game.enums.FigureType.*;
...
public class FigureCreator {
    ...
    private enum MainFigureType {
        ...
        LONG_TYPE(LONG_FIGURE, LONG_SECOND_FIGURE), SQUARE_TYPE(SQUARE_FIGURE), L_TYPE(L_FIGURE, L_SECOND_FIGURE, L_THIRD_FIGURE, L_FOURTH_FIGURE), T_TYPE(T_FIGURE, T_SECOND_FIGURE, T_THIRD_FIGURE, T_FOURTH_FIGURE), J_TYPE(J_FIGURE, J_SECOND_FIGURE, J_THIRD_FIGURE, J_FOURTH_FIGURE), S_TYPE(S_FIGURE, S_SECOND_FIGURE), Z_TYPE(Z_FIGURE, Z_SECOND_FIGURE);
